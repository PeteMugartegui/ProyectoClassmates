...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2012 a las 08:11:01
...
CREATE TABLE IF NOT EXISTS `horario` (
  ...
  `minuto` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(2, 'Analisis y Diseño', '0000-00-00', 9, '10', 'am'),
(3, 'Base de Datos', '0000-00-00', 10, '11', 'am'),
(4, 'Circuitos', '0000-00-00', 12, '13', 'pm'),
(5, 'Programación', 'Miercoles', 9, '10', 'am'),
(6, 'Sistemas Digitales', 'Lunes', 8, '9', 'am'),
(7, 'Base de Datos', 'Viernes', 2, '00', 'pm');
